...
**Important:** The `BASE_URL` environment variable controls what domain appears in your short URLs and QR codes. For production, set this to your actual domain (e.g., `https://short.ly`).
